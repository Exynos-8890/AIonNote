...
try:
    from myapi import get_zhipu_response, get_kimi_response, get_gpt_response
except:
    from tools.myapi import get_zhipu_response, get_kimi_response, get_gpt_response
...
def run_index(running_ID):
    ...
    df.loc[running_ID, "content"] = get_gpt_response(prompt_with_content)
